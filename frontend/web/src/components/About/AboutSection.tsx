      ...
      <div className="about-inner">
        <div className="about-grid">
          ...
          <div className="about-content">
            ...
            <a className="about-plant-button" href="#packages">
              <span className="about-plant-button-label">{t('about.cta')}</span>
              <span className="about-plant-icon about-plant-icon-1" aria-hidden="true">
                <svg viewBox="0 0 208.52 511.88" focusable="false">
              ...
              <span className="about-plant-icon about-plant-icon-2" aria-hidden="true">
                <svg viewBox="0 0 420.62 554.38" focusable="false">
              ...
              <span className="about-plant-icon about-plant-icon-3" aria-hidden="true">
                <svg viewBox="0 0 313.64 405.79" focusable="false">
              ...
              <span className="about-plant-icon about-plant-icon-4" aria-hidden="true">
                <svg viewBox="0 0 359.65 724.72" focusable="false">
              ...
              <span className="about-plant-icon about-plant-icon-5" aria-hidden="true">
                <svg viewBox="0 0 513.57 1042.57" focusable="false">
