        ...
        {authUser ? (
          <div className="nav-account" ref={accountRef}>
            <div className="nav-garden" aria-hidden="true">
              ...
              {Array.from({ length: 6 }, (_, index) => (
                <span className={`nav-garden-flower nav-garden-flower-${index + 1}`} key={index}>
          ...
          <>
            ...
            >
              ...
              <span className="nav-action-leaf nav-action-leaf-1" aria-hidden="true">
              ...
              <span className="nav-action-leaf nav-action-leaf-2" aria-hidden="true">
              ...
              <span className="nav-action-leaf nav-action-leaf-3" aria-hidden="true">
