...
export function Navbar() {
  ...
  const [authUser, setAuthUser] = useState<NavAuthUser | null>(() =>
    readStoredUser(),
  );
      ...
      <div className="nav-actions">
        {authUser ? (
          <div className="nav-account" ref={accountRef}>
            <div className="nav-garden" aria-hidden="true">
              <span className="nav-garden-tendril nav-garden-tendril-1">
                <span />
                <span />
              </span>
              <span className="nav-garden-tendril nav-garden-tendril-2">
                <span />
                <span />
              </span>
              <span className="nav-garden-tendril nav-garden-tendril-3">
                <span />
                <span />
              </span>
              <span className="nav-garden-vine nav-garden-vine-left">
                <span />
                <span />
                <span />
              </span>
              <span className="nav-garden-vine nav-garden-vine-right">
                <span />
                <span />
                <span />
              </span>
              {Array.from({ length: 6 }, (_, index) => (
                <span
                  className={`nav-garden-flower nav-garden-flower-${index + 1}`}
                  key={index}
                >
                  <span className="nav-garden-petal nav-garden-petal-one" />
                  <span className="nav-garden-petal nav-garden-petal-two" />
                  <span className="nav-garden-petal nav-garden-petal-three" />
                  <span className="nav-garden-petal nav-garden-petal-four" />
                </span>
              ))}
            </div>
            <button
              ...
              <div className="account-dropdown" role="menu">
                  ...
                  <div className="account-detail-grid">
                    {profileDetails.map((item) => (
                      <div className="account-detail-item" key={item.label}>
                        ...
                        <strong>
                          {item.value || accountLabels.notUpdated}
                        </strong>
                      </div>
                    ))}
                  </div>
                ...
                <div className="account-setting-row">
                  ...
                  <div
                    ...
                    role="group"
                    aria-label={accountLabels.theme}
                  >
                    <button
                ...
                <div className="account-setting-row">
                  ...
                  <div
                    className="account-segmented"
                    role="group"
                    aria-label={accountLabels.language}
                  >
                    <button
          ...
          <>
            ...
            >
              <span className="nav-action-label">{t("nav.plan")}</span>
              <span
                className="nav-action-leaf nav-action-leaf-1"
                aria-hidden="true"
              >
                <svg viewBox="0 0 26.3 65.33" focusable="false">
              ...
              <span
                className="nav-action-leaf nav-action-leaf-2"
                aria-hidden="true"
              >
                <svg viewBox="0 0 11.67 37.63" focusable="false">
              ...
              <span
                className="nav-action-leaf nav-action-leaf-3"
                aria-hidden="true"
              >
                <svg viewBox="0 0 25.29 76.92" focusable="false">
