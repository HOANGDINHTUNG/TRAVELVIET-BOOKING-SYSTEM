  ...
  return (
    <div ref={rootRef} className="relative">
      <button
        ...
        title={triggerAria}
        onClick={() => {
          if (!open) setDraft({ language, currency, theme });
          setOpen((v) => !v);
        }}
      >
        <LocaleLanguageIcon
        ...
        >
          <div className="hlp-panel__grid">
            <section className="hlp-panel__col">
              <h3 className="hlp-panel__heading">
                {t("header.localePanel.language")}
              </h3>
              <button
                type="button"
                className={cn(
                  "hlp-option",
                  draft.language === "vi" && "is-selected",
                )}
            ...
            <section className="hlp-panel__col">
              <h3 className="hlp-panel__heading">
                {t("header.localePanel.currency")}
              </h3>
              <button
                type="button"
                className={cn(
                  "hlp-option",
                  draft.currency === "VND" && "is-selected",
                )}
              ...
              <button
                ...
                className={cn(
                  "hlp-option",
                  draft.currency === "USD" && "is-selected",
                )}
