 ...
 */
export const PRODUCTION_API_BASE_URL = import.meta.env.VITE_API_PUBLIC_BASE_URL;

export const DEVELOPMENT_API_BASE_URL = import.meta.env.VITE_API_LOCAL_BASE_URL;
