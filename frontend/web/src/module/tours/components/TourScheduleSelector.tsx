...
export function TourScheduleSelector(props: TourScheduleSelectorProps) {
  ...
  if (props.isLoading) {
    return (
      <div className="flex min-h-[140px] items-center justify-center gap-3 rounded-2xl border border-blue-50/80 bg-white/70 px-4 py-8 text-sm text-slate-600 shadow-sm">
        <Loader2
  ...
  if (bookable.length === 0) {
    return (
      <div className="rounded-2xl border border-dashed border-slate-200 bg-white/60 px-4 py-10 text-center shadow-sm">
        <CalendarRange
            ...
            <div
              ...
              className={`bg-white transition-colors cursor-pointer ${
                isSelected
                  ...
                  : "rounded-full px-6 py-4 flex flex-col sm:flex-row sm:items-center justify-between shadow-sm border border-slate-200 hover:border-blue-300"
              }`}
            >
              {isSelected ? (
                <div className="p-6 flex flex-col gap-6">
                    ...
                    <div className="flex items-center gap-6">
                      ...
                      <div className="text-sm text-slate-500 flex items-center gap-2 truncate">
                        ...
                        <span className="truncate flex items-center gap-2">
                          <span className="border border-slate-300 text-slate-400 text-[8px] px-1 rounded block leading-none py-0.5">
                            🎫
                          </span>
                  ...
                  <div>
                    ...
                    <div className="flex flex-col sm:flex-row justify-between items-center text-sm gap-4">
                      <div className="w-full sm:w-1/3">
                        <div className="flex justify-between text-slate-500 mb-1 border-b border-slate-100 pb-2 border-dashed">
                      ...
                      <div className="w-full sm:w-1/3 flex items-center mx-4">
                        <div className="w-full border-t-2 border-dashed border-slate-200 relative mt-4">
                          <span className="absolute -top-3 left-1/2 -translate-x-1/2 text-[10px] bg-white px-2 text-blue-500 italic font-bold">
                            Vietravel Airlines
                          </span>
                        </div>
                      </div>
                  ...
                  <div className="mt-4 pt-6 border-t border-slate-100">
                    <div className="text-center text-sm font-bold text-slate-700 mb-6">
                      Giá chuyến đi
                    </div>
                    <div className="grid grid-cols-2 gap-y-6 gap-x-8 text-sm max-w-3xl mx-auto">
                      ...
                      <div className="flex justify-between items-center pl-6 border-l border-slate-100">
                        <div>
                ...
                <>
                  ...
                  <div className="flex items-center gap-4 shrink-0 justify-between sm:justify-end mt-4 sm:mt-0">
                    ...
                    <button
                      className="px-5 py-2 rounded-full transition-colors text-xs font-semibold bg-slate-50 text-slate-600 hover:bg-slate-100"
                      onClick={(e) => {
                        e.stopPropagation();
