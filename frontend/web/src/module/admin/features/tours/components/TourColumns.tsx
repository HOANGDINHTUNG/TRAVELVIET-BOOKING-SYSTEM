        ...
        <DropdownMenu.Portal>
          ...
          >
            <DropdownMenu.Item
              ...
              className="flex items-center gap-2.5 px-3 py-2 text-sm font-bold cursor-pointer text-indigo-700 dark:text-indigo-400 hover:bg-indigo-50 dark:hover:bg-indigo-900/30 rounded-md focus:bg-indigo-50 dark:focus:bg-indigo-900/30 focus:outline-none transition-colors"
            >
              <CalendarDays size={16} /> Lịch khởi hành & Sĩ số
            </DropdownMenu.Item>
