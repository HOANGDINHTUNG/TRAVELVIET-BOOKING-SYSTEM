...
export default function ComboPage() {
  ...
  const { data, isLoading, isFetching } = useGetCombos(
    ...
    <div className="space-y-6 max-w-full pb-8">
        ...
        <div className="flex items-center gap-4 relative z-10">
          ...
          <div>
            ...
            <p className="text-sm text-slate-500 mt-0.5 font-medium">
              Thiết lập các sản phẩm bán kèm, ghép khối combo và ưu đãi gộp
              chung.
            </p>
          </div>
        </div>
        ...
        <div className="flex items-center gap-3 w-full sm:w-auto relative z-10">
          <div className="relative flex-1 sm:flex-none">
            ...
            <input
              ...
              placeholder="Tìm kiếm Code Combo..."
      ...
      <ComboForm
        ...
        onOpenChange={(v: boolean) => {
          setFormOpen(v);
          if (!v) setTimeout(() => setEditingCombo(null), 200);
        }}
