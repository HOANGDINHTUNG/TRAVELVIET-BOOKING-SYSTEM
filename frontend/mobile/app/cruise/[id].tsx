...
import { styles } from '../tour/tour-detail.styles';
...
export default function CruiseDetailScreen() {
  ...
  const highlights = language === 'vi' ? detail.highlightsVi : detail.highlightsEn;
  const itinerary = language === 'vi' ? detail.itineraryVi : detail.itineraryEn;
  const description = language === 'vi' ? detail.descriptionVi : detail.descriptionEn;
    ...
    <View style={dynamicStyles.container}>
            ...
            <View style={styles.heroContent}>
              <View style={styles.heroBadgeRow}>
                <View style={styles.heroBadge}>
                  <Text style={styles.heroBadgeText}>{t('cruises_title', 'Du thuyền')}</Text>
                </View>
                <View style={styles.heroBadge}>
        ...
        <View style={styles.content}>
          <View style={dynamicStyles.engagementPanel}>
            ...
            <View style={styles.priceBlock}>
              <Text style={dynamicStyles.priceLabel}>{t('cruises_price_from', 'Giá từ')}</Text>
              <Text style={styles.priceValue}>{formatPrice(cruise.priceNum)}</Text>
            </View>
          </View>
      ...
      <View style={dynamicStyles.bottomBar}>
        <View>
          ...
          <Text style={dynamicStyles.bottomPrice}>{formatPrice(cruise.priceNum)}</Text>
        </View>
        <TouchableOpacity
          style={styles.bookButton}
          onPress={() =>
            router.push({ pathname: '/checkout/[id]', params: { id: cruise.id } })
          }
        >
