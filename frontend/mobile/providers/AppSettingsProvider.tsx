...
const TRANSLATIONS: Record<string, { vi: string; en: string }> = {
  ...
  search_placeholder: { vi: 'Bạn muốn đi đâu hôm nay?', en: 'Where do you want to go today?' },
  ...
  settings: { vi: 'Tùy chọn hiển thị & Cài đặt', en: 'Display Options & Settings' },
  ...
  // Explore Screen
  explore_hero_title: { vi: 'Khám phá các điểm đến hấp dẫn', en: 'Explore Attractive Destinations' },
  explore_search_placeholder: { vi: 'Tìm kiếm điểm danh lam thắng cảnh...', en: 'Search for attractions and destinations...' },
  explore_region_prefix: { vi: 'Khu vực', en: 'Region' },
  explore_search_results: { vi: 'Kết quả tìm kiếm', en: 'Search Results' },
  explore_search_subtext: { vi: 'Các điểm đến khớp với từ khóa của bạn', en: 'Destinations matching your search' },
  explore_no_destinations: { vi: 'Không tìm thấy điểm đến nào', en: 'No destinations found' },
  explore_continent_title: { vi: 'Khám phá theo châu lục', en: 'Explore by Continent' },
  explore_continent_subtext: { vi: 'Tìm hành trình khắp năm châu cùng TravelViet', en: 'Find journeys across the five continents with TravelViet' },
  ...
  explore_vn_desc: { vi: 'Vẻ đẹp bất tận của thiên nhiên, văn hóa Việt', en: 'Endless beauty of Vietnamese nature & culture' },
  explore_asia_desc: { vi: 'Giao thoa giữa truyền thống & hiện đại', en: 'Intersection of tradition & modernity' },
  explore_europe_desc: { vi: 'Nền văn minh lâu đời rực rỡ', en: 'Brilliant ancient civilization' },
  explore_americas_desc: { vi: 'Tân thế giới cùng thiên nhiên hùng vĩ', en: 'New world with majestic nature' },
  explore_africa_desc: { vi: 'Cội nguồn hoang dã đầy kỳ thú', en: 'Wild origins full of wonders' },
  explore_domestic_title: { vi: 'Điểm đến của thời gian mới', en: 'Trending Destinations' },
  explore_domestic_subtext: { vi: 'Mùa này bạn đi đâu chơi?', en: 'Where are you travelling this season?' },
  explore_intl_title: { vi: 'Điểm đến quốc tế nổi bật', en: 'Featured International Destinations' },
  explore_intl_subtext: { vi: 'Khám phá thế giới rộng lớn bên ngoài', en: 'Explore the vast world outside' },
  ...
  bookings_subtitle: { vi: 'Quản lý các đơn tour bạn đã đặt — thanh toán, hủy hoặc xem lại chi tiết.', en: 'Manage your booked tours — pay, cancel or view details.' },
  ...
  bookings_no_trips_sub: { vi: 'Bạn chưa có đơn đặt tour nào.', en: 'You have not booked any tours yet.' },
  ...
  hotels_subtitle: { vi: 'Tìm kiếm phòng nghỉ thoải mái, sang trọng cho chuyến đi của bạn', en: 'Find comfortable and luxurious stays for your journey' },
  combos_title: { vi: 'Combo Du lịch Tiết kiệm', en: 'Super Saver Travel Combos' },
  combos_subtitle: { vi: 'Trọn gói Vé máy bay + Khách sạn chất lượng tốt nhất', en: 'All-in-one Flight + Hotel packages at the best rates' },
  ...
  checkout_subtitle: { vi: 'Vui lòng hoàn thành các thông tin và thực hiện thanh toán để xác nhận chỗ của bạn', en: 'Please complete details and make payment to confirm your booking' },
  ...
  checkout_passengers: { vi: 'Số lượng hành khách', en: 'Number of passengers' },
  ...
  checkout_price_per_adult: { vi: 'Giá vé người lớn', en: 'Adult ticket price' },
  ...
  checkout_success_msg: { vi: 'Đơn đặt chỗ của bạn đã được tiếp nhận và xử lý!', en: 'Your booking has been received and is being processed!' },
  ...
  cruises_subtitle: { vi: 'Trải nghiệm hải trình đẳng cấp 5 sao trên những vịnh biển đẹp nhất Việt Nam.', en: 'Experience 5-star luxury cruises on Vietnam\'s most beautiful bays.' },
  cruises_search_placeholder: { vi: 'Tìm tên du thuyền, vịnh biển...', en: 'Search cruise name, bay...' },
  cruises_empty: { vi: 'Không tìm thấy du thuyền phù hợp', en: 'No matching cruises found' },
  cruises_empty_sub: { vi: 'Hãy thử thay đổi từ khóa tìm kiếm.', en: 'Please try changing search keywords.' },
...
export const AppSettingsProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  const [userAvatar, setUserAvatar] = useState('https://images.unsplash.com/photo-1494790108377-be9c29b29330?q=80&w=200');
