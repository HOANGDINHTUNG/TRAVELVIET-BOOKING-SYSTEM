...
const translations = {
  vi: {
    ...
    locationDesc:
      "Giúp hiển thị thời tiết hiện tại và đề xuất các điểm đến, danh lam thắng cảnh, cũng như các tour du lịch gần bạn nhất.",
    notiTitle: "Thông báo đẩy",
    notiDesc:
      "Nhận thông báo về các ưu đãi đặc quyền, tin tức khuyến mãi mới nhất, dự báo thời tiết thời gian thực và cập nhật trạng thái đơn đặt tour.",
  ...
  en: {
    ...
    locationDesc:
      "Helps show current weather and recommend popular destinations, attractions, and travel tours closest to your location.",
    notiTitle: "Push Notifications",
    notiDesc:
      "Get alerts on exclusive deals, latest promo news, real-time weather forecasts, and updates on your booked tours.",
...
export function PermissionModal() {
  ...
  useEffect(() => {
    ...
    const checkPermissions = async () => {
      try {
        ...
        let notiStatus = "undetermined";
        try {
          const notiPerm = await Notifications.getPermissionsAsync();
          notiStatus = notiPerm.status;
        } catch {
          // expo-notifications not supported on this build (Expo Go SDK 53+)
          notiStatus = "granted"; // treat as granted to avoid blocking the user
        }
  ...
  const handleAllow = async () => {
    ...
    try {
      ...
      // Prompt native notification permission (may fail in Expo Go)
      try {
      ...
      <View style={styles.overlay}>
        <View style={[styles.card, isDark && styles.cardDark]}>
          ...
          <View style={styles.header}>
            ...
            <Text style={[styles.subtitle, isDark && styles.textSubDark]}>
              {t.sub}
            </Text>
          </View>
          ...
          <View style={styles.list}>
            ...
            <View style={styles.item}>
              ...
              <View style={styles.itemContent}>
                ...
                <Text style={[styles.itemDesc, isDark && styles.textSubDark]}>
                  {t.locationDesc}
                </Text>
              </View>
            </View>
          ...
          {loading ? (
            ...
            <View style={styles.actions}>
              ...
              >
                <Text
                  style={[styles.skipButtonText, isDark && styles.textSubDark]}
                >
                  {t.skipBtn}
                </Text>
              </TouchableOpacity>
