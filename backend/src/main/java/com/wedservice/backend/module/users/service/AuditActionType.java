...
public enum AuditActionType {
    ...
    WEATHER_DISPLAY_POLICY_UPDATE("weather_display_policy.update", "weather_display_policies"),
    WEATHERAPI_SYNC("weatherapi.sync", "destinations"),
    ...
    WEATHER_PUBLIC_NOTICE_CREATE("weather_public_notice.create", "weather_public_notices"),
    WEATHER_PUBLIC_NOTICE_UPDATE("weather_public_notice.update", "weather_public_notices"),
    WEATHER_PUBLIC_NOTICE_STATUS_UPDATE("weather_public_notice.status.update", "weather_public_notices"),
